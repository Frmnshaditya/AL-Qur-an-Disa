...
export const PublicLandingPage: React.FC<PublicLandingPageProps> = ({
  ...
  const [regDisability, setRegDisability] = useState<'tunanetra' | 'tunarungu' | 'tunadaksa' | 'intelektual_autisme' | 'pendamping_umum'>('tunanetra');
  ...
  const filteredEvents = useMemo(() => {
    return activeEvents.filter(ev => {
      ...
      if (filterDisability !== 'Semua') {
        const disText = filterDisability.toLowerCase();
        if (disText === 'umum') {
          const allText = `${ev.jenisEvent} ${ev.targetPeserta} ${ev.namaKegiatan} ${ev.deskripsiPelatihan}`.toLowerCase();
          if (!allText.includes('umum')) return false;
        } else {
          const allText = `${ev.jenisEvent} ${ev.namaKegiatan} ${ev.deskripsiPelatihan} ${ev.kebutuhanPeserta.join(' ')}`.toLowerCase();
          if (!allText.includes(disText.replace(/[^a-z]/g, ''))) {
            return false;
          }
        }
      }
  ...
  return (
    <div className="min-h-screen w-full flex flex-col font-sans bg-white text-slate-800">
      ...
      <nav className="sticky top-0 z-40 w-full border-b bg-white border-slate-100 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-[17px] sm:text-[19px] tracking-tight leading-tight text-slate-900">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            <div className="hidden lg:flex items-center gap-6 text-[14px] font-medium text-slate-600">
              <a href="#tentang-kami" className="hover:text-slate-900 transition-colors">
                Tentang Kami
              </a>
              <a href="#katalog-event" className="hover:text-slate-900 transition-colors">
                Cari Event
              </a>
              <a href="#peta-lokasi" className="hover:text-slate-900 transition-colors">
                Peta Lokasi
              </a>
              <a href="#kontak-kami" className="hover:text-slate-900 transition-colors">
                Kontak
              </a>
              <button
                type="button"
            ...
            {currentUser ? (
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-[#1e293b] text-white hover:bg-slate-800 rounded-xl text-[13px] sm:text-[14px] font-semibold transition-all shadow-xs cursor-pointer"
              >
              ...
              <button
                onClick={() => onOpenLogin()}
                className="px-5 py-2.5 border border-slate-300 hover:border-slate-400 text-slate-800 hover:bg-slate-50 rounded-xl text-[13px] sm:text-[14px] font-semibold transition-all cursor-pointer shadow-2xs"
              >
                Login
              </button>
            )}
      ...
      <section id="tentang-kami" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full border-t border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12">
          ...
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-6 text-center">
            <span className="block text-4xl sm:text-5xl font-extrabold text-slate-900 mb-2">
              {disabilities.length > 0 ? disabilities.length : 4}
            </span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full bg-slate-50/70 border-t border-b border-slate-200/70">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1: Netra */}
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs flex flex-col hover:border-slate-300 transition-all">
            ...
            <h4 className="text-[16px] font-bold text-slate-900 mb-2">Disabilitas Netra</h4>
            <p className="text-[13px] text-slate-600 leading-relaxed">
              Materi Braille, audio description, pembaca layar (NVDA/JAWS), panduan mobilitas.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs flex flex-col hover:border-slate-300 transition-all">
            ...
            <h4 className="text-[16px] font-bold text-slate-900 mb-2">Disabilitas Rungu & Wicara</h4>
            <p className="text-[13px] text-slate-600 leading-relaxed">
              Juru Bahasa Isyarat (BISINDO/SIBI), closed captioning, materi visual interaktif.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs flex flex-col hover:border-slate-300 transition-all">
            ...
            <h4 className="text-[16px] font-bold text-slate-900 mb-2">Disabilitas Daksa & Fisik</h4>
            <p className="text-[13px] text-slate-600 leading-relaxed">
              Aksesibilitas ramp, toilet ramah kursi roda, lokasi dekat aksesibilitas transportasi penjemputan.
            </p>
          </div>

          {/* Card 4: Intelektual & Sensorik */}
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs flex flex-col hover:border-slate-300 transition-all">
            <div className="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-700 flex items-center justify-center mb-4">
              <span className="material-symbols-outlined text-[26px]">psychology</span>
            </div>
            <h4 className="text-[16px] font-bold text-slate-900 mb-2">Disabilitas Intelektual & Sensorik</h4>
            <p className="text-[13px] text-slate-600 leading-relaxed">
              Pendamping ramah, metode pengajaran visual terstruktur, ruang tenang (calm room).
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[13px] text-slate-800 focus:outline-none focus:border-slate-800"
              >
                <option value="Semua">Semua Disabilitas / Peserta</option>
                <option value="netra">Disabilitas Netra</option>
                <option value="rungu">Disabilitas Rungu / Tuli</option>
                <option value="daksa">Disabilitas Daksa</option>
                <option value="intelektual">Disabilitas Intelektual</option>
                <option value="umum">Masyarakat Umum / Pendamping</option>
              </select>
            </div>
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      value={regDisability}
                      onChange={e => setRegDisability(e.target.value as any)}
                      className="w-full px-3.5 py-2.5 border border-slate-200 rounded-xl text-[13px] text-slate-900 focus:outline-none focus:border-slate-800"
                    >
                      <option value="tunanetra">Tunanetra (Braille / Low Vision)</option>
                      <option value="tunarungu">Tunarungu / Tuli (Bahasa Isyarat)</option>
                      <option value="tunadaksa">Tunadaksa (Fisik / Kursi Roda)</option>
                      <option value="intelektual_autisme">Disabilitas Intelektual & Sensorik</option>
                      <option value="pendamping_umum">Pendamping / Relawan Umum</option>
                    </select>
                  </div>
                </div>
