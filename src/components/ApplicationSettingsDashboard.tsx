    ...
    <div className="space-y-6 w-full">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-xs space-y-6">
          ...
          <div className="p-4 rounded-xl border border-primary/20 bg-gradient-to-b from-primary/5 to-transparent">
            <div className="flex items-center gap-2 mb-3">
              <span className="material-symbols-outlined text-primary text-[18px]">preview</span>
              <span className="text-[13px] font-bold text-gray-900">
                Live Preview Tampilan Tengah Halaman Web Utama:
              </span>
            </div>

            <div
              className={`flex flex-col items-center justify-center text-center p-8 rounded-2xl border shadow-sm relative overflow-hidden transition-all ${
                formData.headerBgImage
            ...
            >
              ...
              <h2
                className={`relative z-10 text-[20px] sm:text-[26px] font-extrabold tracking-tight mb-1.5 ${
              ...
              <div
                className={`relative z-10 inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-[12px] font-bold mb-1.5 shadow-2xs ${
                  formData.headerBgImage && formData.headerBgOverlay !== 'light'
              ...
              <p
                className={`relative z-10 text-[12px] sm:text-[13px] font-semibold tracking-wider uppercase ${
                  formData.headerBgImage && formData.headerBgOverlay !== 'light'
